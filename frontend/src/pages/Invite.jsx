  ...
  return (
    <div style={{minHeight:"100vh",background:"#0d0d1a",display:"flex",alignItems:"center",justifyContent:"center",padding:"24px 16px"}}>
      <div style={{width:"100%",maxWidth:400,color:"#fff",textAlign:"center"}}>
        ...
        <h1 style={{margin:"0 0 6px",fontSize:28,fontWeight:700,color:"#00f5d4"}}>Rejoindre la session</h1>
        ...
        <div style={{background:"#111",borderRadius:16,padding:"28px 24px",border:"1px solid #222"}}>
          ...
          <button onClick={join}
            style={{width:"100%",padding:"16px",background:"#00f5d4",border:"none",borderRadius:10,fontWeight:"bold",cursor:"pointer",fontSize:17,color:"#0d0d1a"}}>
            Rejoindre →
          </button>
        </div>
