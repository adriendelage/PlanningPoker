    ...
    <div style={{ minHeight: "100vh", background: "#0d0d1a", display: "flex", alignItems: "center", justifyContent: "center", padding: "24px 16px" }}>
      <div style={{ width: "100%", maxWidth: 540, color: "#fff" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 36 }}>
          ...
          <h1 style={{ margin: 0, fontSize: 32, fontWeight: 700, color: "#9b5de5" }}>Kanban léger</h1>
          <p style={{ margin: "8px 0 0", color: "#555", fontSize: 15 }}>
            Un tableau partagé qui survit aux redémarrages — le lien suffit pour y revenir
          </p>
        </div>
        ...
        <div style={{ background: "#111", borderRadius: 16, padding: "28px 24px", border: "1px solid #222" }}>
          ...
          <label style={labelStyle}>Nom du tableau</label>
          <input placeholder="Ex: Sprint 43" value={name}
            onChange={e => setName(e.target.value)}
            onKeyDown={e => e.key === "Enter" && create()}
            style={inputStyle} />

          <button onClick={create}
            style={{ width: "100%", padding: 16, background: "#9b5de5", border: "none", borderRadius: 10, fontWeight: "bold", cursor: "pointer", fontSize: 17, color: "#fff" }}>
            Créer le tableau →
          </button>

          <p style={{ margin: "16px 0 0", fontSize: 13, color: "#555", textAlign: "center" }}>
            Contrairement aux sessions Poker et Rétro, un tableau Kanban est permanent :
            garde le lien et reviens quand tu veux.
          </p>
        </div>
